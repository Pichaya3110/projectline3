...
function saveQuiz(){
    ...
    var choice1 =document.getElementById('1a1');
    var choice2 =document.getElementById('1a2');
    var choice3 =document.getElementById('1a3');
    var choice4 =document.getElementById('1a4');
    //var firebaseRef = firebase.database().ref("webquest");
    //firebaseRef.child("question").set("Blue");
    //firebaseRef.child("choices/one").set("Yes");
    //firebaseRef.child("choices/two").set("No");
    insertData(question.value,choice1.value,choice2.value,choice3.value,choice4.value);
